...
//	class MailUtilsException extends Exception{};
	...
	class TestMailUtils extends MailUtils
	{
		...
		public function setTemplate($file)
		{
			if (!is_readable($this->templateDir.$file))
				throw new MailUtilsException('Не могу прочитать файл "'.$this->templateDir.$file.'"');
		...
		{
		    try {
//				dump($this->encodingLine($this->encodingContext($this->to))."\n");
//				dump($this->encodingLine($this->encodingContext($this->subject))."\n");
//				dump($this->encodeAttachments().$this->encodingContext($this->body)."\n");
